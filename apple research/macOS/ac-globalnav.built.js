(function e(b, g, d) {
    ...
    13: [function(g, h, d) {
        ...
        i.prototype = {
            ...
            removeExpired: function() {
                ...
                if (f.available()) {
                    for (n = 0;
                    n < window.localStorage.length; n++) {
    ...
    17: [function(f, d, h) {
        ...
        var i = null;
        try {
            i = f("@marcom/ac-storage")
        } catch (k) {}
        var p = f("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var n = f("mustache");
        var j = f("Base64");
        var a = f("./cookie.js");
        var l = "ac-store-cache";
        var o = {
        ...
        var m = function m(q) {
            if (q && q.length > 0) {
                q[0]["first"] = true;
                q[q.length - 1]["last"] = true
            }
            return q || []
        };
        var g = function(I, J, Q, A) {
            p.call(this);
            var D = this;
            var B = null;
            var C = null;
            ...
            var G = function G(T, U) {
                var R;
                var S = N[T];
                var V = S !== U;
                if (V && typeof S === "object" && U === "object") {
                    V = false;
                    for (R in U) {
                        V = V || U[R] !== S[R]
                    }
                ...
                if (V) {
                    N[T] = U;
                    D.trigger(T + "Change", U)
                }
            };
            var z = function z(T, V, R) {
                var S = (T.indexOf("?") === -1 ? "?" : "&");
                var U = /(%5B|\[)storefront(%5D|\])/g;
                T = T.replace(U, V.storefront || J);
                T = T.indexOf("//") === 0 ? window.location.protocol + T : T;
                T += S + "apikey=" + encodeURIComponent(Q);
                T += R ? "&l=" + encodeURIComponent(window.location + "") : "";
                return new Promise(function(Y, X) {
                    try {
                        var W = new XMLHttpRequest();
                        W.onreadystatechange = function aa() {
                            if (W.readyState === 4) {
                                try {
                                    var ac = JSON.parse(W.responseText);
                                    Y(ac)
                                } catch (ab) {
                                    X()
                                }
            ...
            var u = function() {
                var S = (window.decodeURIComponent(window.escape(j.atob(a.getAs("sfa") || ""))) || "").split("|");
                var R = function R(T) {
                    return S[0] === "2" && T === 9 ? S[2] : S[0] === "2" && T > 1 ? S[T + 1] : S[T]
                };
                C = C || {
                    version: R(0),
                    storefront: R(1),
                    ...
                    segmentCode: R(4),
                    channelCode: R(5),
                    showBanner: R(6) === "1" || R(6) === "true",
                    persistBanner: R(7) === "1" || R(7) === "true",
                    bagEnabled: R(8) !== "0" && R(8) !== "false",
                    consumerStorefront: R(9)
                };
                return C
            };
            var M = function M() {
            ...
            var y = function y() {
                ...
                var V = true;
                var R = null;
                w = w || (M().then(function(aa) {
                    var ab = a.getAs("cn");
                    var Y = aa.storefront || J;
                    var W = /([^\/]*)\/\/([^\/]*)\/.*/;
                    var X = (document.referrer || "").replace(W, "$2");
                    var Z = (document.location + "").replace(W, "$2");
                    B = B || c.getItem(l);
                    S = aa.bagEnabled;
                    V = aa.showBanner;
                    T = B && ((F && B.ttl === 0) || (U < B.ttl && ab === B.cn && Q === B.key && Y === B.sfLoc && (!X || X === Z)));
                    return T || !S ? Promise.resolve() : z(A, aa, false).then(function(ac) {
                        R = isNaN(parseInt(ac.items, 10));
                        B = {
                            ttl: (parseInt(ac.ttl, 10) * 1000 + U) || 0,
                            items: !R ? parseInt(ac.items, 10) : 0,
                            cn: ab,
                            api: ac.api,
                            key: Q,
                            sfLoc: Y
            ...
            var s = u();
            var v = s.consumerStorefront;
            if (!!v && !!J && v !== J) {
                t(true)
            }
            this.getStoreState = function P() {
                return y().then(function() {
                    return N.storeState
                })
            };
            this.getItemCount = function r() {
                return y().then(function() {
                    return N.itemCount
                })
            };
            this.__setItemCount = function E(R) {
                q = null;
                G("itemCount", R);
                if (B) {
                    B.items = R;
            ...
            this.getStorefront = M;
            this.exitStorefront = t;
            this.addItem = function K(R) {
                return new Promise(function(T, S) {
                    this.trigger("itemAdded");
                    T()
                })
            };
            this.addFavorite = function L(R) {
                return new Promise(function(T, S) {
                    this.trigger("favoriteAdded");
                    T()
                })
            };
            this.updateBagFlyout = function x() {
                if (q === null) {
                    I.innerHTML = n.render(o.items, {
                        loading: {
                            text: "Loading..."
                        }
                    });
                    q = true;
                    (B && B.api ? Promise.resolve() : y()).then(M).then(function(U) {
                        var T = B && B.api && B.api.flyout;
                        if (!T) {
                        ...
                        q = U || {};
                        q.bag = q.bag || {};
                        q.bag["items"] = m(q.bag["items"]);
                        q.links = m(q.links);
                        q.promoLinks = m(q.promoLinks);
                        q.buttons = m(q.buttons);
                        if (q.bag["items"].length === 0 && !q.message) {
                            q.message = {
                                type: "empty",
                                text: q.bag["emptyBagMsg"]
                            }
                        }
                        if (q.bag["extraItemsMsg"]) {
                            q.lineMessage = {
                                text: q.bag["extraItemsMsg"]
                            }
                        }
                        if (q.links.length > 0) {
                            q.navigation = {
                                noBtn: q.buttons.length <= 0,
                                links: q.links
                            }
                        }
                        if (q.promoLinks.length > 0) {
                            q.explodedPromoLinks = {
                                promoLinks: q.promoLinks
                            }
                        }
                        for (var T = 0;
                        T < q.bag["items"].length; T += 1) {
                            var V = q.bag["items"][T] || {};
                            V.qty = V.qty > 1 ? {
                                text: V.qty
                            } : false
                        }
                        I.innerHTML = n.render(o.items, q)
                    }, function R() {
                        q = null
                    })
                }
            };
            this.clearCache = function O(R) {
                if (!R || !F) {
                    c.removeItem(l);
                    B = null;
                    C = null;
        ...
        "@marcom/ac-polyfills/Object/create": 161,
        "@marcom/ac-polyfills/Promise": 163,
        "@marcom/ac-storage": 5,
        Base64: 16,
        mustache: 192
    }],
    ...
    116: [function(c, d, b) {
        ...
        "./helpers/globals": 109,
        "@marcom/ac-function/once": 124,
        "@marcom/ac-polyfills/matchMedia": 165
    }],
    117: [function(c, d, b) {
        var g = c("./helpers/globals");
        var f = c("@marcom/ac-function/once");
    ...
    132: [function(c, d, b) {
        ...
        "./extend": 135,
        "@marcom/ac-polyfills/Array/isArray": 151
    }],
    133: [function(b, d, a) {
        var f = function() {};
    ...
    140: [function(c, f, b) {
        ...
        "@marcom/ac-url/joinSearchParams": 126
    }],
    141: [function(b, c, a) {
    ...
    171: [function(b, a, f) {
        ...
        "@marcom/ac-polyfills/Object/create": 161,
        "@marcom/ac-polyfills/Object/keys": 162
    }],
    172: [function(i, c, x) {
    ...
    177: [function(b, f, a) {
        ...
        "./request": 176,
        "ac-object/toQueryParameters": 173
    }],
    178: [function(b, d, a) {
        var c = b("./request");
        var f = function() {
 ...
 */
        (function a(h, g) {
            ...
            L.name = "http://images.apple.com/ac/globalnav/2.0/en_US/scripts/mustache.js";
            L.version = "2.2.1";
            L.tags = ["{{", "}}"];
            var V = new q();
    ...
    193: [function(b, c, a) {
        ...
        "@marcom/ac-polyfills/Function/prototype.bind": 159,
        "@marcom/ac-polyfills/Object/create": 161,
        "@marcom/ac-polyfills/String/prototype.trim": 164,
    ...
    194: [function(m, d, D) {
        ...
        "@marcom/ac-headjs/FeatureDetect": 125,
        "@marcom/ac-object/defaults": 134,
        "@marcom/ac-viewport-emitter/ViewportEmitter": 171
    }],
    195: [function(c, b, d) {
    ...
    197: [function(d, c, h) {
        ...
        "@marcom/ac-string/toCamelCase": 169
    }],
    198: [function(b, c, a) {
        c.exports = {
            BACKSPACE: 8,
    ...
    205: [function(g, c, h) {
        ...
        i._jsonToData = function(s) {
            ...
            m++) {
                ...
                if (t.sectionResults.length) {
                    ...
                    for (l = 0; l < t.sectionResults.length;
                    l++) {
        ...
        "./sectionLabels": 209,
        "@marcom/ac-polyfills/Date/now": 157,
        "@marcom/ac-polyfills/JSON": 160,
        "ac-ajax-xhr": 174,
        "ac-mvc-model": 190
    }],
    206: [function(d, c, g) {
        ...
        h.setSelectedElement = function(r, q) {
            var p;
            for (p = 0; p < this._selectableItems.length;
            p++) {
